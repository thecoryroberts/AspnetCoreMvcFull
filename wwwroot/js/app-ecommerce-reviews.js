...
document.addEventListener('DOMContentLoaded', function (e) {
          ...
          render: function (data, type, full, meta) {
            return `
              <div class="text-xxl-center">
                <div class="dropdown">
                  <a href="javascript:void(0);" class="btn btn-icon dropdown-toggle hide-arrow p-0" data-bs-toggle="dropdown">
  ...
  setTimeout(() => {
    const elementsToModify = [
      ...
      { selector: '.dt-buttons.btn-group', classToAdd: 'justify-content-center' },
      ...
      { selector: '.review_filter .form-select', classToAdd: 'w-px-150' },
      { selector: '.dt-buttons', classToAdd: 'mb-0' },
      {
        selector: '.dt-layout-end',
        classToAdd: 'd-flex flex-md-row flex-column gap-md-0 gap-5 px-3 mb-md-0 mb-5 mt-0'
      },
      {
        selector: '.dt-layout-end .dt-length',
